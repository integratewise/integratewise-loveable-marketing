...
import { BookOpen, FileText, Layers, Sparkles, Star, Users, Rocket, Workflow, ArrowRight } from "lucide-react";
...
const STORIES = [
  { to: "/blog", icon: FileText, label: "Blog", body: "Real-world stories about ending the Human API role." },
  { to: "/why", icon: Star, label: "Why IntegrateWise", body: "The deeper reasoning behind Digital Memory and the Adaptive Spine." },
  { to: "/manifesto", icon: FileText, label: "Manifesto", body: "Principles like \u201CTruth you own. AI you rent. Approval in between.\u201D" },
  { to: "/customer-zero", icon: Rocket, label: "Customer Zero", body: "How the founder runs IntegrateWise on IntegrateWise." },
];
          ...
          <div className="mx-auto mt-12 grid max-w-5xl gap-4 md:grid-cols-2">
            {PRODUCT_LEARNING.map((c, i) => (
              <Reveal key={c.label} delay={i * 60}>
                <Link to={c.to} className="card-iw flex items-start gap-4 p-6 transition-colors hover:border-brand-highlight/40">
        ...
        <Container>
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-[16px] text-text-secondary">
              ...
              <Link to="/changelog" className="text-brand-accent hover:underline">Changelog</Link> for more.
            </p>
          </Reveal>
