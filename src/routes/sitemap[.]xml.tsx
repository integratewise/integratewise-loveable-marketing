...
// Only canonical, content-bearing routes. Aliases that 301-redirect to a hub
// anchor (e.g. /platform/the-spine → /platform#spine) are intentionally
// excluded so search engines see one source of truth per topic.
