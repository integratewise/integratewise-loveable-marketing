...
const ROUTES: Array<{ path: string; changefreq: string; priority: string }> = [
  ...
  { path: "/solutions/role", changefreq: "monthly", priority: "0.7" },
  { path: "/solutions/industry", changefreq: "monthly", priority: "0.7" },
  { path: "/solutions/by-role", changefreq: "monthly", priority: "0.5" },
  { path: "/solutions/by-industry", changefreq: "monthly", priority: "0.5" },
