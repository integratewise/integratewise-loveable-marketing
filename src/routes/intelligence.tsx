...
export const Route = createFileRoute("/intelligence")({
  head: () => ({
    meta: [
      { title: "Intelligence — Twin reads your Digital Memory. Proposes. Never acts alone." },
      {
        name: "description",
        content:
          "Twin doesn't work on raw data. It reads scoped Digital Memory and proposes structured changes with linked evidence and confidence. The Approval Gate decides what becomes real — every action logged, outcome looped back as a Session Summary.",
      },
      { property: "og:title", content: "IntegrateWise Intelligence — Twin" },
      {
        property: "og:description",
        content:
          "Twin proposes structured changes against Digital Memory, never raw data. Approval Gate sits between Twin and your tools — no silent actions.",
      },
    ],
  }),
...
const IS_NOT_LIST = [
  ...
  "Not a permanent memory store — Digital Memory lives in the Spine, not in the model.",
];
    ...
    <>
          ...
          <div className="grid items-center gap-10 lg:grid-cols-[1.1fr_1fr]">
            <Reveal>
              ...
              <div className="mt-7 flex flex-wrap items-center gap-3">
                ...
                <button onClick={() => open("Intelligence · hero")} className="btn-secondary-iw">
                  Book a demo
                </button>
              </div>
            </Reveal>
      ...
      <SectionNav
        items={[
          ...
          { id: "digital-memory-reference", label: "Digital Memory" },
        ...
        <Container>
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-5 text-[16px] leading-relaxed text-text-secondary">
              Digital Memory is yours — a growing record of your data and decisions. Twin is rented
              intelligence that sits outside the Spine. It reads from your Digital Memory, prepares
      ...
      {/* 4. Grounded in Digital Memory */}
      <Section alt>
        <Container>
          <Reveal className="mx-auto max-w-3xl text-center">
            <Badge variant="muted">Digital Memory</Badge>
            <h2 className="heading-h2 mt-4">
              Grounded in your Digital Memory, not the open internet.
            </h2>
            <p className="mt-4 text-[16px] leading-relaxed text-text-secondary">
              Twin answers from your records, communications, and approved summaries instead of
              wandering across the web. Models can be swapped; your Digital Memory stays.
            </p>
          </Reveal>
            ...
            <div className="card-iw p-6 md:p-8" style={{ background: "var(--bg-surface)" }}>
              ...
              <div className="mt-2 rounded-xl border border-border bg-elevated/50 p-4">
                <p className="flex items-center gap-1.5 text-[12px] font-semibold uppercase tracking-wider text-text-secondary">
                  <BookOpen size={13} /> Digital Memory
                </p>
      ...
      <Section id="digital-memory-reference" alt>
        <Container>
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="heading-h2 mt-4">
              Digital Memory is Twin's reference — read-only, evidence-first.
            </h2>
            <p className="mt-4 text-[16px] leading-relaxed text-text-secondary">
              {MEMORY_COPY.primary}
            </p>
            <p className="mt-3 text-[15px] text-text-secondary">
              Twin reads from accumulated Digital Memory to compare past and present, but{" "}
              <span className="text-foreground/90">never writes directly into it</span>. Every
          ...
          <div className="mx-auto mt-10 grid max-w-4xl gap-4 sm:grid-cols-3">
            <div className="card-iw p-5">
              ...
              <p className="mt-1 text-[13px] text-text-secondary">
                Twin sees only User Memory, Work Memory, or Org Memory you've granted it.
              </p>
            </div>
            <div className="card-iw p-5">
              ...
              <p className="mt-1 text-[13px] text-text-secondary">
                Every Twin suggestion shows the Digital Memory it was built on.
              </p>
            </div>
            <div className="card-iw p-5">
      ...
      <Section>
        <Container>
          <Reveal className="mx-auto max-w-3xl text-center">
            <h2 className="heading-h2">Watch your Twin work on your own Digital Memory.</h2>
            ...
            <div className="mt-7 flex flex-wrap items-center justify-center gap-3">
              ...
              <button onClick={() => open("Intelligence · CTA")} className="btn-secondary-iw">
                Book a demo
              </button>
            </div>
